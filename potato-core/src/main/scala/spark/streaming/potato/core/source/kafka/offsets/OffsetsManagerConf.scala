package spark.streaming.potato.core.source.kafka.offsets

import kafka.common.InvalidConfigException
import kafka.consumer.ConsumerConfig
import spark.streaming.potato.core.source.kafka.KafkaSourceConstants.KAFKA_SOURCE_PREFIX
...
object OffsetsManagerConf {
  ...
  implicit def toConsumerConfig(config: OffsetsManagerConf): ConsumerConfig = {
    import spark.streaming.potato.core.source.kafka.utils.OffsetsUtilImplicits.mapToProperties
