...
package object conf {
  ...
  val POTATO_KAFKA_PRODUCER_FAILED_THRESHOLD_KEY: String = POTATO_KAFKA_PRODUCER_PREFIX + "failed.threshold" // non used
  val POTATO_KAFKA_PRODUCER_FAILED_THRESHOLD_DEFAULT: String = 0.toString
