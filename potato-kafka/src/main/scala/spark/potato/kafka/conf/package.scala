...
package object conf {
  ...
  val POTATO_KAFKA_CONSUMER_OFFSET_RESET_POLICY: String = POTATO_KAFKA_CONSUMER_CONF_PREFIX + "auto.offset.reset"
  ...
  val POTATO_KAFKA_SUBSCRIBE_TOPICS_KEY: String = POTATO_KAFKA_SOURCE_PREFIX + "subscribe.topics"
