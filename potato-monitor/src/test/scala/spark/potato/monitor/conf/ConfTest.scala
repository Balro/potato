...
class ConfTest {
  ...
  def keyTest(): Unit = {
    ...
    val escape = Seq(
      POTATO_MONITOR_BACKLOG_THRESHOLD_MS_KEY,
      POTATO_MONITOR_BACKLOG_REPORTER_INTERVAL_MS_KEY,
      POTATO_MONITOR_BACKLOG_REPORTER_MAX_KEY,
      POTATO_MONITOR_BACKLOG_NOTIFY_TYPE_KEY,
      POTATO_MONITOR_BACKLOG_NOTIFY_DING_TOKEN_KEY,
      POTATO_MONITOR_BACKLOG_NOTIFY_DING_AT_ALL_KEY,
      POTATO_MONITOR_BACKLOG_NOTIFY_DING_AT_PHONES_KEY
