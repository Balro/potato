...
class ConfTest {
  ...
  def keyTest(): Unit = {
    ...
    val escape = Seq(
      ...
      POTATO_MONITOR_STREAMING_BACKLOG_THRESHOLD_MS_KEY,
      POTATO_MONITOR_STREAMING_BACKLOG_REPORT_INTERVAL_MS_KEY,
      POTATO_MONITOR_STREAMING_BACKLOG_REPORT_MAX_KEY,
      POTATO_MONITOR_STREAMING_BACKLOG_REPORT_SENDER_KEY
